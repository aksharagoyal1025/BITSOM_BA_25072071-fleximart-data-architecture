...
-- have placed at least 2 orders and spent more than ₹5,000. Order by total amount
...
-- For each month: month name, total number of orders, total revenue,
-- and running total of revenue from January to that month.
